...
class modSubtableHelper
{
	...
	public function getconverterAjax() {
		...
		$link = '<a href="https://umikatechnologies.com"  target="_blank" rel="following"><img src="'.JURI::root().'modules/mod_subtable/assets/images/umikatechnologies.png" alt="Umika Technologies LLP"></a>';
